...
---------------------- ITENS SURVIVAL ---------------------------
-----------------------------------------------------------------
	["barber"] = function(source,Passport,Amount,Slot,Full,Item,Split)
	...
	["tattoo"] = function(source,Passport,Amount,Slot,Full,Item,Split)
        TriggerClientEvent("inventory:Close",source)
	...
	["firstaidbandage"] = function(source,Passport,Amount,Slot,Full,Item,Split)
	...
	["redtea"] = function(source, Passport, Amount, Slot, Full, Item, Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 7
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close", source)
		TriggerClientEvent("Progress", source, "Bebendo Chá Vermelho", 7000)
		vRPC.CreateObjects(source, "mp_player_intdrink", "loop_bottle", "prop_ld_flow_bottle", 49, 60309, 0.0, 0.0, -0.06, 0.0, 0.0, 130.0)
	...
	["goldenrodTea"] = function(source, Passport, Amount, Slot, Full, Item, Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 7
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close", source)
		TriggerClientEvent("Progress", source, "Bebendo Chá Dourado", 7000)
		vRPC.CreateObjects(source, "mp_player_intdrink", "loop_bottle", "prop_ld_flow_bottle", 49, 60309, 0.0, 0.0, -0.06, 0.0, 0.0, 130.0)
	...
	["grandpasMoonshine"] = function(source, Passport, Amount, Slot, Full, Item, Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 7
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close", source)
	...
	["beer"] = function(source, Passport, Amount, Slot, Full, Item, Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 10
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close", source)
		TriggerClientEvent("Progress", source, "Bebendo Cerveja", 10000)
		vRPC.CreateObjects(source, "amb@world_human_drinking@beer@male@idle_a", "idle_a", "prop_amb_beer_bottle", 49, 60309, 0.0, 0.0, -0.06, 0.0, 0.0, 130.0)
		...
		repeat
			if Active[Passport] and os.time() >= parseInt(Active[Passport]) then
				...
				if	vRP.TakeItem(Passport, Full, 1, true, Slot) then
					...
					vRP.DowngradeHealth(Passport, 2)
					vRP.GenerateItem(Passport, "emptybottle", 1)
	...
	["whisky"] = function(source, Passport, Amount, Slot, Full, Item, Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 12
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close", source)
		TriggerClientEvent("Progress", source, "Bebendo Whisky", 12000)
		vRPC.CreateObjects(source, "amb@world_human_drinking@beer@male@idle_a", "idle_a", "prop_cs_whiskey_bottle", 49, 60309, 0.0, 0.0, -0.06, 0.0, 0.0, 130.0)
		...
		repeat
			if Active[Passport] and os.time() >= parseInt(Active[Passport]) then
				...
				if vRP.TakeItem(Passport, Full, 1, true, Slot) then
					...
					vRP.DowngradeHealth(Passport, 4)
					vRP.GenerateItem(Passport, "emptybottle", 1)
					vRP.AlcoholTimer(Passport, 30)
					TriggerClientEvent("Drunk", source)
				end
	...
	["bread"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 8
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close",source)
		TriggerClientEvent("Progress", source, "Tomando", 8000)
	...
	["canChili"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 8
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close",source)
	...
	["canSoup"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 8
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close",source)
	...
	["canPasta"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 8
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close",source)
	...
	["canBeef"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 8
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close",source)
	...
	["canFish"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 8
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close",source)
	...
	["canCatfood"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 8
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close",source)
		...
		repeat
			if Active[Passport] and os.time() >= parseInt(Active[Passport]) then
				...
				if vRP.TakeItem(Passport,Full,1,true,Slot) then
					...
					TriggerClientEvent("Notify", source, "Atenção", "Você Comeu <b>1x "..ItemName(Item).."</b> estragado.", "amarelo", 5000)
				end
			end
	...
	["canDogfood"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		vRPC.AnimActive(source)
		Active[Passport] = os.time() + 8
		Player(source)["state"]["Buttons"] = true
		TriggerClientEvent("inventory:Close",source)
